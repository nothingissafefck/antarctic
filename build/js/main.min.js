  ...
  window.addEventListener('load', function () {
    ...
    var observer = new IntersectionObserver(function (entries) {
      if (entries[0].isIntersecting) {
        Object(_modules_map__WEBPACK_IMPORTED_MODULE_3__["initMap"])({
          id: 'map',
          initials: {
...
var toggleMenuControls = document.querySelectorAll('[data-menu-toggle]');
var closeMenuControls = document.querySelectorAll('[data-menu-close]');
var content = document.querySelector('main');
function toggleMenu(close) {
  // eslint-disable-next-line no-undefined
  var force = close !== undefined ? !close : undefined;
...
function initMenu() {
  toggleMenuControls.forEach(function (control) {
